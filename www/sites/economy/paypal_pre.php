...
if ($_SESSION[purchase_id] != '')
{
	...
	$do_post_requested = simplecurrency_do_post_request($found);
	...
	else
	{
		...
		<table>
			...
			<tr>
				<td colspan="2">
					<a href="send_to_paypal.php"><img align="right" style="float:right" src="images/economy/paypal-purchase-button.png" /></a>
				</td>
			</tr>
			<tr>
